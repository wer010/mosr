...
class Viewer(moderngl_window.WindowConfig):
    ...
    def run(self, *args, save_fig = False, log=True):
        """
        ...
        while not self.window.is_closing:
            ...
            # if save_fig:
            #     screenshot_name = "frame_{:0>6}.png".format(self.scene.current_frame_id)
            #     self.take_screenshot(screenshot_name, self.screenshot_transparent)
